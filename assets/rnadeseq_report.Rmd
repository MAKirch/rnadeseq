            ...
            if (nrow(df) <= 100 & nrow(df) > 0) {
                ...
                for (i in c(1:nrow(df))){
                    ...
                    if (!isProvided(params$citest) & nrow(mat)>1){
                        ...
                        main_title <- paste0(
                          "Heatmap of normalized expression values (z-scores)\n",
                          "Pathway: ", pathway$short_name, " (", pathway$source, ")"
                        )
                        ...
                        tryCatch(
                            {
                                ...
                                pheatmap(mat = mat, annotation_col = metadata_save, main = main_title, scale = "row", cluster_cols = params$heatmaps_cluster_cols, cluster_rows = params$heatmaps_cluster_rows, fontsize_row = fontsize_row, show_rownames = show_rownames)
                                dev.off()
                            },
                            error=function(e) {
